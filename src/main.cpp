...
int main([[maybe_unused]] int argc, [[maybe_unused]] char ** argv) {
    ...
    Spritesheet_Animator samurai2_attack("../resources/samurai/Attack1.png", 200, 200, 6, 0.10f, samurai2_rect.get_rect());
    Entity samurai2(samurai2_rect, samurai2_right_run, samurai2_left_run, samurai2_idle, samurai2_attack, 2.5f);
