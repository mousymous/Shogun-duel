...
int main([[maybe_unused]] int argc, [[maybe_unused]] char ** argv) {
    ...
    Rect samurai_rect(true, sf::Color(0,0,0), sf::Vector2f(100, 400));
    ...
    Entity samurai(samurai_rect, samurai_right_run, samurai_left_run, samurai_idle, samurai_attack,2.0f);
